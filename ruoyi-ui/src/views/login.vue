<template>
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      <h3 class="title">HomeX Management System</h3>
      ...
      <el-checkbox v-model="loginForm.rememberMe" style="margin:0px 0px 25px 0px;">rememberMe</el-checkbox>
    ...
    <div class="el-login-footer">
      <span>Copyright © 2018-2019 HomeX Management System All Rights Reserved.</span>
    </div>
  </div>
</template>
